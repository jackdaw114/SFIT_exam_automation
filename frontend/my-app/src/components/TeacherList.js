            ...
            <div className='mt-5 w-full h-fit flex justify-center text-2xl font-mont font-medium'>
                <div className='w-11/12 flex justify-center '>
                    <div className=' aspect-square grid grid-rows-2 grid-cols-2 w-7/12  gap-8 transition-all'>
                        <TeacherDeptComponent status="EXTC" idx={2} icons={icons_components} bgColor="bg-[#6699CC]" />
                        <TeacherDeptComponent status="INFT" idx={0} icons={icons_components} bgColor="bg-[#A0dbbC]" />
                        <TeacherDeptComponent status="CMPN" idx={0} icons={icons_components} bgColor="bg-[#A0dbbC]" />
                        <TeacherDeptComponent status="MECH" idx={1} icons={icons_components} bgColor="bg-[#DE6B48]" />
                    </div>
                </div>
            </div>
        </div>
